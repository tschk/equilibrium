...
fn main() {
    ...
    let gui_template_rs = format!(
        "fn render_crepus_shell<R, P>(ui: PolyglotTemplate<R, P>) -> impl IntoElement where R: Iterator<Item = (String, bool, String, &'static str, &'static str)> + 'static, P: Iterator<Item = String> + 'static {{ let PolyglotTemplate {{ parts, n, mode, is_gui, is_tui, is_dashboard, is_constellation, linked_count, missing_count, gui_rows, gui_constellation_preview_rows, pipeline_scroll: _pipeline_scroll }} = ui; let tui_rows = std::iter::empty::<(String, bool, String, &'static str, &'static str)>(); let tui_constellation_preview_rows = std::iter::empty::<(String, &'static str)>(); let tui_constellation_rows = std::iter::empty::<(String, &'static str)>(); let tui_log_rows = std::iter::empty::<(String, String, &'static str)>(); view! {{{gui_template_literal}}} }}\n"
    );
